...
public class SbeDecoder {
    ...
    private final SbeDecoder parentMessage = this;
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append(ask());
        builder.append('|');
        //Token{signal=BEGIN_VAR_DATA, name='currencyPair', referencedName='null', description='null', id=5, version=0, deprecated=0, encodedLength=0, offset=24, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='currencyPair'}}
