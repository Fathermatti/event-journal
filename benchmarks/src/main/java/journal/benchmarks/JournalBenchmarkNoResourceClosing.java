...
public class JournalBenchmarkNoResourceClosing {
	...
	public void setup() {
	    ...
	    provider = new FileChannelProvider(journalFileManager);
	    
	    NonClosingFileChannelPersister persister = new NonClosingFileChannelPersister(provider);
