...
public class ContinuousWriteUsingDataOutputStream {
	...
	try {
	    persister.dataOutputStream.writeLong(event.val1);
	    persister.dataOutputStream.writeLong(event.val2);
	    persister.dataOutputStream.writeLong(event.val3);
	    persister.dataOutputStream.writeLong(event.val4);
	...
	private File file = new File("DataOutputStream.tst");
